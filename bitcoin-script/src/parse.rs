...
impl MyFromStr for Opcode {
    fn from_str(s: &str) -> Result<Self, ()> {
        match s {
            ...
            "OP_NOP" | "NOP" => Ok(opcodes::all::OP_NOP),
            "OP_IF" | "IF" => Ok(opcodes::all::OP_IF),
            "OP_NOTIF" | "NOTIF" => Ok(opcodes::all::OP_NOTIF),
            "OP_ELSE" | "ELSE" => Ok(opcodes::all::OP_ELSE),
            "OP_ENDIF" | "ENDIF" => Ok(opcodes::all::OP_ENDIF),
            "OP_VERIFY" | "VERIFY" => Ok(opcodes::all::OP_VERIFY),
            "OP_RETURN" | "RETURN" => Ok(opcodes::all::OP_RETURN),
            "OP_TOALTSTACK" | "TOALTSTACK" => Ok(opcodes::all::OP_TOALTSTACK),
            "OP_FROMALTSTACK" | "FROMALTSTACK" => Ok(opcodes::all::OP_FROMALTSTACK),
            "OP_2DROP" | "2DROP" => Ok(opcodes::all::OP_2DROP),
            "OP_2DUP" | "2DUP" => Ok(opcodes::all::OP_2DUP),
            "OP_3DUP" | "3DUP" => Ok(opcodes::all::OP_3DUP),
            "OP_2OVER" | "2OVER" => Ok(opcodes::all::OP_2OVER),
            "OP_2ROT" | "2ROT" => Ok(opcodes::all::OP_2ROT),
            "OP_2SWAP" | "2SWAP" => Ok(opcodes::all::OP_2SWAP),
            "OP_IFDUP" | "IFDUP" => Ok(opcodes::all::OP_IFDUP),
            "OP_DEPTH" | "DEPTH" => Ok(opcodes::all::OP_DEPTH),
            "OP_DROP" | "DROP" => Ok(opcodes::all::OP_DROP),
            "OP_DUP" | "DUP" => Ok(opcodes::all::OP_DUP),
            "OP_NIP" | "NIP" => Ok(opcodes::all::OP_NIP),
            "OP_OVER" | "OVER" => Ok(opcodes::all::OP_OVER),
            "OP_PICK" | "PICK" => Ok(opcodes::all::OP_PICK),
            "OP_ROLL" | "ROLL" => Ok(opcodes::all::OP_ROLL),
            "OP_ROT" | "ROT" => Ok(opcodes::all::OP_ROT),
            "OP_SWAP" | "SWAP" => Ok(opcodes::all::OP_SWAP),
            "OP_TUCK" | "TUCK" => Ok(opcodes::all::OP_TUCK),
            "OP_CAT" | "CAT" => Ok(opcodes::all::OP_CAT),
            "OP_SIZE" | "SIZE" => Ok(opcodes::all::OP_SIZE),
            "OP_EQUAL" | "EQUAL" => Ok(opcodes::all::OP_EQUAL),
            "OP_EQUALVERIFY" | "EQUALVERIFY" => Ok(opcodes::all::OP_EQUALVERIFY),
            "OP_1ADD" | "1ADD" => Ok(opcodes::all::OP_1ADD),
            "OP_1SUB" | "1SUB" => Ok(opcodes::all::OP_1SUB),
            "OP_NEGATE" | "NEGATE" => Ok(opcodes::all::OP_NEGATE),
            "OP_ABS" | "ABS" => Ok(opcodes::all::OP_ABS),
            "OP_NOT" | "NOT" => Ok(opcodes::all::OP_NOT),
            "OP_0NOTEQUAL" | "0NOTEQUAL" => Ok(opcodes::all::OP_0NOTEQUAL),
            "OP_ADD" | "ADD" => Ok(opcodes::all::OP_ADD),
            "OP_SUB" | "SUB" => Ok(opcodes::all::OP_SUB),
            "OP_BOOLAND" | "BOOLAND" => Ok(opcodes::all::OP_BOOLAND),
            "OP_BOOLOR" | "BOOLOR" => Ok(opcodes::all::OP_BOOLOR),
            "OP_NUMEQUAL" | "NUMEQUAL" => Ok(opcodes::all::OP_NUMEQUAL),
            "OP_NUMEQUALVERIFY" | "NUMEQUALVERIFY" => Ok(opcodes::all::OP_NUMEQUALVERIFY),
            "OP_NUMNOTEQUAL" | "NUMNOTEQUAL" => Ok(opcodes::all::OP_NUMNOTEQUAL),
            "OP_LESSTHAN" | "LESSTHAN" => Ok(opcodes::all::OP_LESSTHAN),
            "OP_GREATERTHAN" | "GREATERTHAN" => Ok(opcodes::all::OP_GREATERTHAN),
            "OP_LESSTHANOREQUAL" | "LESSTHANOREQUAL" => Ok(opcodes::all::OP_LESSTHANOREQUAL),
            "OP_GREATERTHANOREQUAL" | "GREATERTHANOREQUAL" => {
                Ok(opcodes::all::OP_GREATERTHANOREQUAL)
            }
            "OP_MIN" | "MIN" => Ok(opcodes::all::OP_MIN),
            "OP_MAX" | "MAX" => Ok(opcodes::all::OP_MAX),
            "OP_WITHIN" | "WITHIN" => Ok(opcodes::all::OP_WITHIN),
            "OP_RIPEMD160" | "RIPEMD160" => Ok(opcodes::all::OP_RIPEMD160),
            "OP_SHA1" | "SHA1" => Ok(opcodes::all::OP_SHA1),
            "OP_SHA256" | "SHA256" => Ok(opcodes::all::OP_SHA256),
            "OP_HASH160" | "HASH160" => Ok(opcodes::all::OP_HASH160),
            "OP_HASH256" | "HASH256" => Ok(opcodes::all::OP_HASH256),
            "OP_CODESEPARATOR" | "CODESEPARATOR" => Ok(opcodes::all::OP_CODESEPARATOR),
            "OP_CHECKSIG" | "CHECKSIG" => Ok(opcodes::all::OP_CHECKSIG),
            "OP_CHECKSIGVERIFY" | "CHECKSIGVERIFY" => Ok(opcodes::all::OP_CHECKSIGVERIFY),
            "OP_CHECKMULTISIG" | "CHECKMULTISIG" => Ok(opcodes::all::OP_CHECKMULTISIG),
            "OP_CHECKMULTISIGVERIFY" | "CHECKMULTISIGVERIFY" => {
                Ok(opcodes::all::OP_CHECKMULTISIGVERIFY)
            }
            "OP_CLTV" | "CLTV" => Ok(opcodes::all::OP_CLTV),
